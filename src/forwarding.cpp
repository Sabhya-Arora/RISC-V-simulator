    ...
    switch (opcode) {
        case 51: //R-type
            ...
            if(l3.non_empty && l3.mem_to_reg && l3.rd!=0 && l3.rd==rs1){
                ...
                if(l3.wb_src == NEXT_PC){
                    id_ex.alu_src1 = L4_PC;
                }
                if(l3.wb_src == MEM){
                    stall = true;
                    break;
            ...
            if(l3.non_empty && l3.mem_to_reg && l3.rd!=0 && l3.rd==rs2){
                if(l3.wb_src == ALU){
                    id_ex.alu_src2 = L4;
                }
                if(l3.wb_src == NEXT_PC){
                    id_ex.alu_src2 = L4_PC;
                }
                if(l3.wb_src == MEM){
                    stall = true;
                    break;
            ...
            if(l4.non_empty && l4.mem_to_reg && l4.rd!=0 && l4.rd==rs1){
                if(l4.wb_src == ALU){
                    id_ex.alu_src1 = L5_ALU;
                }
                if(l4.wb_src == NEXT_PC){
                    id_ex.alu_src1 = L5_PC;
                }
                if(l4.wb_src == MEM){
                    id_ex.alu_src1 = L5_MEM;
                }
            }
            if(l4.non_empty && l4.mem_to_reg && l4.rd!=0 && l4.rd==rs2){
                if(l4.wb_src == ALU){
                    id_ex.alu_src2 = L5_ALU;
                }
                if(l4.wb_src == NEXT_PC){
                    id_ex.alu_src2 = L5_PC;
                }
                if(l4.wb_src == MEM){
                    id_ex.alu_src2 = L5_MEM;
                }
            }
            break;
        case 3: //I-type
        ...
        case 103: // jalr
            ...
            if (funct3 == 0) {
                ...
                id_ex.alu_op = NO_OP;
                int target_pc = rs1_val + id_ex.imm;
                branch = true;
                pc = target_pc - 1;
            } else {
                cout<<"Unsupported instruction"<<endl;
...
struct EX_MEM EX( struct ID_EX id_ex) {
    ...
    switch (id_ex.alu_src1) {
        case RS1:
            operand1 = id_ex.rs1_val;
            break;
        case L4:
            operand1 = l4.alu_result;
            break;
        case L5_ALU:
            operand1 = l5.alu_result;
            break;
        case L5_PC:
            operand1 = l5.pc + 1;
            break;
        case L5_MEM:
            operand1 = l5.mem_result;
            break;
    }
    switch (id_ex.alu_src2) {
        case RS2:
            operand2 = id_ex.rs2_val;
            break;
        case IMM:
            operand2 = id_ex.imm;
            break;
        case L4:
            operand2 = l4.alu_result;
            break;
        case L5_ALU:
            operand2 = l5.alu_result;
            break;
        case L5_PC:
            operand2 = l5.pc + 1;
            break;
        case L5_MEM:
            operand2 = l5.mem_result;
            break;
    }
    switch (id_ex.alu_op) {
        case ADD:
